...
const navItems: NavItem[] = [
  ...
  },
  {
    ...
    children: [
      ...
      { label: "My Exit", path: "/accounting/exit/my-exit", icon: UserMinus, requiredPermission: "exit.view_own" },
      { label: "Exit Management", path: "/accounting/exit", icon: UserX, requiredPermission: "exit.view" },
    ],
  },
