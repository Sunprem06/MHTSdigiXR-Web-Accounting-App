...
export default function CaseStudies() {
  const { data: apiStudies = [], isLoading } = useQuery<CaseStudy[]>({ queryKey: ["/api/case-studies"] });
    ...
    <div className="pt-24 pb-20 bg-white dark:bg-slate-900">
      ...
      <div className="container mx-auto px-4 md:px-6">
        {isLoading ? (
          ...
          <div className="text-center py-12 text-slate-500 dark:text-slate-400">No case studies available yet. Check back soon!</div>
        ) : (
          <div className="grid md:grid-cols-2 gap-8">
            {apiStudies.map((project, index) => (
              <motion.div
                key={project.id}
                initial={{ opacity: 0, y: 20 }}
              ...
              >
                ...
                <div className="p-8">
                  ...
                  <div className="flex flex-wrap gap-2 mb-6">
                    {(Array.isArray(project.results) ? project.results as string[] : []).map((result, i) => (
